...
Replaces the result column type with LargeBinary instead of PickleType in Task model.
"""
...
class Task(ResultModelBase):
    ...
    __tablename__ = "apollo_celery_taskmeta"
    ...
    def __init__(self, task_id):
        print(f"Task.__init__, id={task_id}")
...
class TaskSet(ResultModelBase):
    ...
    __tablename__ = "apollo_celery_tasksetmeta"
    __table_args__ = {"sqlite_autoincrement": True}
