"""
A patch for HuggingFaceEndpointEmbeddings decoupled from langchain-huggingface
heavily torch-dependant package

See original implementation here:
https://raw.githubusercontent.com/langchain-ai/langchain/refs/heads/master/libs/partners/huggingface/langchain_huggingface/embeddings/huggingface_endpoint.py
"""
...
class HuggingFaceEndpointEmbeddings(BaseModel, Embeddings):
    """HuggingFaceHub Text Embedding Inference embedding models.
